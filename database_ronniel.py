...
class DataBaseGUI:
    ...
    def create_database_frame(self):
        ...
        self.window.geometry(f'{800}x{575}')
    ...
    def show(self):
        ...
        db = mysql.connector.connect(host='localhost', user=self.username1, password='', db='college')
        cursor = db.cursor()    
    ...
    def graphPoints(self):
        ...
        try: 
            ...
            wn.bgpic('C:/Users/Ronniel/Downloads/codeEnv-main/codeEnv-main/pup.png')
            wn.update()
    ...
    def show_graph(self):
        ...
        img = mpimg.imread('C:/Users/Ronniel/Downloads/codeEnv-main/codeEnv-main/pup_map.png')
